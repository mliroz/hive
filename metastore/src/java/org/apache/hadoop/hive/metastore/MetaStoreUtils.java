...
public class MetaStoreUtils {
   ...
   *   <li>Its table type is <em>EXTERNAL_TABLE</em> and there is no <em>EXTERNAL</em> parameter
   *   set to <em>false</em></li>
   * </ol>
   *<p>
   ...
   * setting tableType as external or setting <em>EXTERNAL</em> property someone expressly desired
   * to have an external table.<p>
   *
